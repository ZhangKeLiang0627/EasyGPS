...
void SystemInfosView::Style_Init()
{
    ...
    lv_style_set_border_side(&style.focus, LV_BORDER_SIDE_RIGHT); // lv_style_set_border_side锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷式锟斤拷锟斤拷谋呖锟斤拷缘(side)锟侥凤拷锟斤拷锟斤拷锟饺★拷
    ...
    const char *infos)
{
    ...
    lv_obj_clear_flag(icon, LV_OBJ_FLAG_SCROLLABLE); // LV_OBJ_FLAG_SCROLLABLE锟斤拷锟节憋拷示一锟斤拷锟斤拷锟斤拷锟角凤拷晒锟斤拷锟�
